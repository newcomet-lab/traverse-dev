...
function VerseMenu() {
    ...
    const SVERSE_ADDRESS = addresses.SVERSE_ADDRESS;
    const VERSE_ADDRESS = addresses.VERSE_ADDRESS;
                        ...
                        <div className="tooltip">
                            ...
                            {isEthereumAPIAvailable && (
                                <div className="add-tokens">
                                    ...
                                    <div className="divider" />
                                    <div className="tooltip-item" onClick={addTokenToWallet("VERSE", VERSE_ADDRESS)}>
                                        <p>VERSE</p>
                                    </div>
                                    <div className="tooltip-item" onClick={addTokenToWallet("sVERSE", SVERSE_ADDRESS)}>
                                        <p>sVERSE</p>
                                    </div>
                                </div>
                            )}
