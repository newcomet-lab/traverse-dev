...
contract VerseStaking is Ownable {
    ...
    /**
        @notice stake VERSE to enter warmup
        @param _amount uint
        @return bool
     */
    ...
    /**
        @notice retrieve sVERSE from warmup
    ...
    /**
        @notice forfeit sVERSE in warmup and retrieve VERSE
     */
    ...
    /**
        @notice redeem sVERSE for VERSE
        @param _amount uint
        @param _trigger bool
     */
    ...
    /**
        @notice returns the sVERSE index, which tracks rebase growth
        @return uint
     */
    ...
    /**
        @notice returns contract VERSE holdings, including bonuses provided
        @return uint
     */
